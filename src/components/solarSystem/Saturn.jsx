...
import SaturnModel from '../models/SaturnModel';
  ...
  return (
    ...
    <section className='relative flex flex-col justify-center min-h-[70vh] mt-10'>
      <div className='flex flex-row flex-wrap text-[#00d0e3] items-center align-center overflow-hidden'>
              ...
              <div>
                ...
                <div className='flex flex-row flex-wrap description2 backdrop-blur-sm'>
                    <div className='text-justify font-Orbitron text-[#00d0e3] text-sm leading-6 my-8 p-4 w-3/5 max-[1152px]:w-full'>
                        <p> 
                        Saturne, avec ses anneaux lumineux et ses nombreux satellites, est l'une des merveilles célestes les plus fascinantes de notre système solaire.
                        </p>
                    </div>
                  </div>
              </div>
          ...
          <div className='h-[100vh] w-2/3 absolute right-0 top-[-100px] max-[1152px]:relative max-[1152px]:w-full max-[1152px]:mt-[10px] max-[1152px]:flex max-[1152px]:justify-center max-[1152px]:right-0'>
            <SaturnModel />
          </div>
        </div>
    </section>
