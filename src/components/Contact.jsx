    ...
    <div className='bg-[rgba(0,208,227,0.1)] backdrop-blur-sm w-full absolute z-[1] h-full overflow-hidden'>
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form action="#" className="space-y-8">
                <div>
                    <label for="email" className="block mb-2 text-sm font-medium text-white font-Orbitron">Email</label>
                ...
                <div>
                    <label for="subject" className="block mb-2 text-sm font-medium text-white font-Orbitron">Objet</label>
                ...
                <div className="sm:col-span-2">
                    <label for="message" className="block mb-2 text-sm font-medium text-white font-Orbitron">Votre message</label>
